...
public:
    ...
    __u32 get_truncate_seq()
    {
        return truncate_seq;
    }
    uint64_t get_truncate_size()
    {
    ...
    ceph_tid_t get_oldest_flush_tid()
    {
