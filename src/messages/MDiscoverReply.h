...
public:
    ...
    {
        return wanted_base_dir;
    }
    bool get_wanted_xlocked()
    {
        return wanted_xlocked;
    }
    snapid_t get_wanted_snapid()
    {
        return wanted_snapid;
    }

    bool is_flag_error_dn()
    {
        return flag_error_dn;
    }
    bool is_flag_error_dir()
    {
        return flag_error_dir;
    }
    std::string& get_error_dentry()
    {
        return error_dentry;
    }
    ...
    mds_rank_t get_dir_auth_hint() const
    {
        return dir_auth_hint;
    }
    ...
    void set_base_dir_frag(frag_t df)
    {
        base_dir_frag = df;
    }
