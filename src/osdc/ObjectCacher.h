...
public:
    ...
    public:
        ...
        void set_length(loff_t l)
        {
            ex.length = l;
        }
        loff_t end() const
        {
            return ex.start + ex.length;
        }
        loff_t last() const
        {
            return end() - 1;
    ...
    public:
        ...
        uint64_t get_object_number() const
        {
            return object_no;
        }

        object_locator_t& get_oloc()
        {
            return oloc;
        }
        void set_object_locator(object_locator_t& l)
        {
            oloc = l;
        }
...
private:
    ...
    loff_t get_stat_dirty()
    {
        return stat_dirty;
    }
    loff_t get_stat_dirty_waiting()
    {
        return stat_dirty_waiting;
    }
    loff_t get_stat_clean()
    {
        return stat_clean;
    }
    loff_t get_stat_zero()
    {
        return stat_zero;
    }
