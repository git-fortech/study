...
public:
     ...
     */
    void set_balanced_budget()
    {
        keep_balanced_budget = true;
    }
    void unset_balanced_budget()
    {
...
public:
    ...
    int get_client_incarnation() const
    {
        return client_inc.read();
    }
    ...
    int get_global_op_flags()
    {
        return global_op_flags.read();
    }
