...
public:
    ...
    ManagedIterator* GetManagedIterator()
    {
        return mi_;
    }
...
bool ManagedIterator::Valid() const
{
    return valid_;
}
...
Status ManagedIterator::status() const
{
    return status_;
}
...
bool ManagedIterator::TryLock()
{
    return in_use_.try_lock();
}
