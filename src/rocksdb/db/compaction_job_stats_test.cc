...
public:
    ...
    size_t NumberOfUnverifiedStats()
    {
        return expected_stats_.size();
    }

    void set_verify_next_comp_io_stats(bool v)
    {
        verify_next_comp_io_stats_ = v;
    }
    ...
    bool verify_next_comp_io_stats() const
    {
        return verify_next_comp_io_stats_;
    }
