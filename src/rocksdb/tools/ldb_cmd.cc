...
CompactorCommand::CompactorCommand(const vector<string>& params,
    ...
    LDBCommand(options, flags, false,
               BuildCmdLineOptions(
{
    ARG_FROM, ARG_TO, ARG_HEX, ARG_KEY_HEX,
...
DBLoaderCommand::DBLoaderCommand(const vector<string>& params,
    ...
    LDBCommand(options, flags, false,
               BuildCmdLineOptions(
{
    ARG_HEX, ARG_KEY_HEX, ARG_VALUE_HEX,
...
ManifestDumpCommand::ManifestDumpCommand(const vector<string>& params,
    ...
    LDBCommand(options, flags, false,
               BuildCmdLineOptions(
{
    ARG_VERBOSE, ARG_PATH, ARG_HEX, ARG_JSON
})),
verbose_(false),
json_(false),
path_("")
...
ReduceDBLevelsCommand::ReduceDBLevelsCommand(const vector<string>& params,
    ...
    LDBCommand(options, flags, false,
               BuildCmdLineOptions(
{
    ARG_NEW_LEVELS, ARG_PRINT_OLD_LEVELS
})),
old_levels_(1 << 7),
new_levels_(-1),
...
ScanCommand::ScanCommand(const vector<string>& params,
    ...
    LDBCommand(options, flags, true,
               BuildCmdLineOptions(
{
    ARG_TTL, ARG_HEX, ARG_KEY_HEX, ARG_TO,
