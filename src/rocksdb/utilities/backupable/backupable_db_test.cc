...
public:
    ...
    void SetGetChildrenFailure(bool fail)
    {
        get_children_failure_ = fail;
    }
    ...
    void SetNewDirectoryFailure(bool fail)
    {
        new_directory_failure_ = fail;
    }
...
public:
    ...
    void CloseBackupEngine()
    {
        backup_engine_.reset(nullptr);
    }
