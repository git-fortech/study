...
struct WriteBatchWithIndex::Rep
{
    ...
    {
        last_entry_offset = write_batch.GetDataSize();
    }
...
WriteBatch* WriteBatchWithIndex::GetWriteBatch()
{
...
void WriteBatchWithIndex::SetSavePoint()
{
    rep->write_batch.SetSavePoint();
}
