...
public:
    ...
    struct Enode : public boost::intrusive::unordered_set_base_hook<>
    {
        ...
        friend void intrusive_ptr_add_ref(Enode *e)
        {
            e->get();
        }
        friend void intrusive_ptr_release(Enode *e)
        {
            e->put();
        }
    ...
    struct TransContext
    {
        ...
        const char *get_state_name()
        {
            ...
            case STATE_KV_QUEUED:
                return "kv_queued";
            case STATE_KV_COMMITTING:
                return "kv_committing";
            case STATE_KV_DONE:
                return "kv_done";
            case STATE_WAL_QUEUED:
                return "wal_queued";
            case STATE_WAL_APPLYING:
                return "wal_applying";
            case STATE_WAL_AIO_WAIT:
                return "wal_aio_wait";
            case STATE_WAL_CLEANUP:
                return "wal_cleanup";
            case STATE_WAL_DONE:
                return "wal_done";
