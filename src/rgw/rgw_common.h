...
public:
    ...
    map<string, string>& get_sub_resources()
    {
...
public:
    ...
    std::map<string, string, ltstr_nocase>& get_map()
    {
        return env_map;
    }
};
...
struct RGWBucketInfo
{
    ...
    bool versioned()
    {
        return (flags & BUCKET_VERSIONED) != 0;
    }
    int versioning_status()
    {
        return flags & (BUCKET_VERSIONED | BUCKET_VERSIONS_SUSPENDED);
    }
    bool versioning_enabled()
    {
        return versioning_status() == BUCKET_VERSIONED;
    }

    bool has_swift_versioning()
    {
        return swift_versioning;
    }
...
public:
    ...
    const std::string& get_orig_obj() const
    {
        return orig_obj;
    }
