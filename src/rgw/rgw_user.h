...
struct RGWUserAdminOpState
{
    ...
    bool has_existing_user()
    {
        return existing_user;
    }
    bool has_existing_key()
    {
        return existing_key;
    }
    bool has_existing_subuser()
    {
        return existing_subuser;
    }
    bool has_existing_email()
    {
        return existing_email;
    }
    bool has_subuser()
    {
        return subuser_specified;
    }
    bool has_key_op()
    {
        return key_op;
    ...
    bool has_caps_op()
    {
        return caps_specified;
    }
    bool has_suspension_op()
    {
        return suspension_op;
    }
    bool has_subuser_perm()
    {
        return perm_specified;
    }
    bool has_op_mask()
    {
        return op_mask_specified;
    }
    bool will_gen_access()
    {
        return gen_access;
    }
    bool will_gen_secret()
    {
        return gen_secret;
    }
    bool will_gen_subuser()
    {
        return gen_subuser;
    }
    ...
    bool will_purge_data()
    {
        return purge_data;
    }
    bool will_generate_subuser()
    {
        return gen_subuser;
    }
    bool has_bucket_quota()
    {
        return bucket_quota_specified;
    }
    bool has_user_quota()
    {
        return user_quota_specified;
    }
    void set_populated()
    {
        populated = true;
    ...
    void set_existing_user(bool flag)
    {
        existing_user = flag;
    }
    void set_existing_key(bool flag)
    {
        existing_key = flag;
    }
    void set_existing_subuser(bool flag)
    {
        existing_subuser = flag;
    }
    void set_existing_email(bool flag)
    {
        existing_email = flag;
    }
    void set_purge_data(bool flag)
    {
        purge_data = flag;
    }
    void set_generate_subuser(bool flag)
    {
        gen_subuser = flag;
    }
    __u8 get_suspension_status()
    {
        return suspended;
    }
    int32_t get_key_type()
    {
        return key_type;
    }
    uint32_t get_subuser_perm()
    {
        return perm_mask;
    }
    uint32_t get_max_buckets()
    {
        return max_buckets;
    }
    uint32_t get_op_mask()
    {
        return op_mask;
    }
    RGWQuotaInfo& get_bucket_quota()
    {
        return bucket_quota;
    }
    RGWQuotaInfo& get_user_quota()
    {
        return user_quota;
    }

    rgw_user& get_user_id()
    {
        return user_id;
    }
    std::string get_subuser()
    {
        return subuser;
    }
    ...
    map<int, std::string>& get_temp_url_keys()
    {
