                   ...
                   int arg1, int arg2, uint64_t poly, gf_t *base)
{
    ...
    if (w < 1 || (w > 32 && w != 64 && w != 128))
    {
        _gf_errno = GF_E_BAD___W;
        return 0;
    }
    ...
    if (mult_type == GF_MULT_DEFAULT)
    {
        if (divide_type != GF_DIVIDE_DEFAULT)
        {
            _gf_errno = GF_E_MDEFDIV;
            return 0;
        }
        if (region_type != GF_REGION_DEFAULT)
        {
            _gf_errno = GF_E_MDEFREG;
            return 0;
        }
        if (arg1 != 0 || arg2 != 0)
        {
            _gf_errno = GF_E_MDEFARG;
            return 0;
        }
        return 1;
    }
    ...
    if (rsimd && rnosimd)
    {
        _gf_errno = GF_E_SIMD_NO;
        return 0;
    }
    if (rcauchy && w > 32)
    {
        _gf_errno = GF_E_CAUGT32;
        return 0;
    }
    if (rcauchy && region_type != GF_REGION_CAUCHY)
    {
        _gf_errno = GF_E_CAUCHYB;
        return 0;
    }
    if (rcauchy && mult_type == GF_MULT_COMPOSITE)
    {
        _gf_errno = GF_E_CAUCOMP;
        return 0;
    }
    ...
    if (divide_type == GF_DIVIDE_MATRIX && w > 32)
    {
        _gf_errno = GF_E_MATRIXW;
        return 0;
    }
    ...
    if (rdouble)
    {
        if (rquad)
        {
            _gf_errno = GF_E_DOUQUAD;
            return 0;
        }
        if (mult_type != GF_MULT_TABLE)
        {
            _gf_errno = GF_E_DOUBLET;
            return 0;
        }
        if (w != 4 && w != 8)
        {
            _gf_errno = GF_E_DOUBLEW;
            return 0;
        }
        if (rsimd || rnosimd || raltmap)
        {
            _gf_errno = GF_E_DOUBLEJ;
            return 0;
        }
        if (rlazy && w == 4)
        {
            _gf_errno = GF_E_DOUBLEL;
            return 0;
        }
        return 1;
    }
    ...
    if (rquad)
    {
        if (mult_type != GF_MULT_TABLE)
        {
            _gf_errno = GF_E_QUAD__T;
            return 0;
        }
        if (w != 4)
        {
            _gf_errno = GF_E_QUAD__W;
            return 0;
        }
        if (rsimd || rnosimd || raltmap)
        {
            _gf_errno = GF_E_QUAD__J;
            return 0;
        }
        return 1;
    }
    ...
    if (mult_type == GF_MULT_SHIFT)
    {
        if (raltmap)
        {
            _gf_errno = GF_E_ALTSHIF;
            return 0;
        }
        if (rsimd || rnosimd)
        {
            _gf_errno = GF_E_SSESHIF;
            return 0;
        }
        return 1;
    }
    ...
    if (mult_type == GF_MULT_CARRY_FREE)
    {
        if (w != 4 && w != 8 && w != 16 &&
                w != 32 && w != 64 && w != 128)
        {
            _gf_errno = GF_E_CFM___W;
            return 0;
        }
        if (w == 4 && (poly & 0xc))
        {
            _gf_errno = GF_E_CFM4POL;
            return 0;
        }
        if (w == 8 && (poly & 0x80))
        {
            _gf_errno = GF_E_CFM8POL;
            return 0;
        }
        if (w == 16 && (poly & 0xe000))
        {
            _gf_errno = GF_E_CF16POL;
            return 0;
        }
        if (w == 32 && (poly & 0xfe000000))
        {
            _gf_errno = GF_E_CF32POL;
            return 0;
        }
        if (w == 64 && (poly & 0xfffe000000000000ULL))
        {
            _gf_errno = GF_E_CF64POL;
            return 0;
        }
        if (raltmap)
        {
            _gf_errno = GF_E_ALT_CFM;
            return 0;
        }
        if (rsimd || rnosimd)
        {
            _gf_errno = GF_E_SSE_CFM;
            return 0;
        }
        if (!pclmul)
        {
            _gf_errno = GF_E_PCLMULX;
            return 0;
        }
        return 1;
    }
    ...
    if (mult_type == GF_MULT_BYTWO_p || mult_type == GF_MULT_BYTWO_b)
    {
        if (raltmap)
        {
            _gf_errno = GF_E_ALT_BY2;
            return 0;
        }
        if (rsimd && !sse2)
        {
            _gf_errno = GF_E_BY2_SSE;
            return 0;
        }
        return 1;
    }
            ...
            || mult_type == GF_MULT_LOG_ZERO_EXT )
    {
        if (w > 27)
        {
            _gf_errno = GF_E_LOGBADW;
            return 0;
        }
        if (raltmap || rsimd || rnosimd)
        {
            _gf_errno = GF_E_LOG___J;
            return 0;
        }
    ...
    if (mult_type == GF_MULT_GROUP)
    {
        if (arg1 <= 0 || arg2 <= 0)
        {
            _gf_errno = GF_E_GR_ARGX;
            return 0;
        }
        if (w == 4 || w == 8)
        {
            _gf_errno = GF_E_GR_W_48;
            return 0;
        }
        if (w == 16 && (arg1 != 4 || arg2 != 4))
        {
            _gf_errno = GF_E_GR_W_16;
            return 0;
        }
        if (w == 128 && (arg1 != 4 ||
                         (arg2 != 4 && arg2 != 8 && arg2 != 16)))
        {
            _gf_errno = GF_E_GR_128A;
            return 0;
        }
        if (arg1 > 27 || arg2 > 27)
        {
            _gf_errno = GF_E_GR_A_27;
            return 0;
        }
        if (arg1 > w || arg2 > w)
        {
            _gf_errno = GF_E_GR_AR_W;
            return 0;
        }
        if (raltmap || rsimd || rnosimd)
        {
    ...
    if (mult_type == GF_MULT_TABLE)
    {
        if (w != 16 && w >= 15)
        {
            _gf_errno = GF_E_TABLE_W;
            return 0;
        }
        if (w != 4 && (rsimd || rnosimd))
        {
            _gf_errno = GF_E_TAB_SSE;
            return 0;
        }
        if (rsimd && !sse3)
        {
            _gf_errno = GF_E_TABSSE3;
            return 0;
        }
        if (raltmap)
        {
            _gf_errno = GF_E_TAB_ALT;
            return 0;
        }
        return 1;
    }
    ...
    if (mult_type == GF_MULT_SPLIT_TABLE)
    {
        ...
        if (w == 8)
        {
            if (arg1 != 4 || arg2 != 8)
            {
                _gf_errno = GF_E_SP_8_AR;
                return 0;
            }
            if (rsimd && !sse3)
            {
                _gf_errno = GF_E_SP_SSE3;
                return 0;
            }
            if (raltmap)
            {
                _gf_errno = GF_E_SP_8__A;
                return 0;
            }
        }
        else if (w == 16)
        {
                    ...
                    (arg1 == 8 && arg2 == 16))
            {
                if (rsimd || rnosimd)
                {
                    _gf_errno = GF_E_SP_16_S;
                    return 0;
                }
                if (raltmap)
                {
                    _gf_errno = GF_E_SP_16_A;
                    return 0;
                }
            }
        ...
        else if (w == 32)
        {
                    ...
                    (arg1 == 16 && arg2 == 32))
            {
                if (rsimd || rnosimd)
                {
                    _gf_errno = GF_E_SP_32_S;
                    return 0;
                }
                if (raltmap)
                {
                    _gf_errno = GF_E_SP_32_A;
                    return 0;
                }
            }
        ...
        else if (w == 64)
        {
                    ...
                    (arg1 == 16 && arg2 == 64))
            {
                if (rsimd || rnosimd)
                {
                    _gf_errno = GF_E_SP_64_S;
                    return 0;
                }
                if (raltmap)
                {
                    _gf_errno = GF_E_SP_64_A;
                    return 0;
                }
            }
        ...
        else if (w == 128)
        {
            if (arg1 == 8 && arg2 == 128)
            {
                if (rsimd || rnosimd)
                {
                    _gf_errno = GF_E_SP128_S;
                    return 0;
                }
                if (raltmap)
                {
                    _gf_errno = GF_E_SP128_A;
                    return 0;
                }
            }
            ...
            {
                _gf_errno = GF_E_SP128AR;
                return 0;
            }
        }
        else
        {
            _gf_errno = GF_E_SPLIT_W;
            return 0;
        }
        return 1;
    }
    ...
    if (mult_type == GF_MULT_COMPOSITE)
    {
        if (w != 8 && w != 16 && w != 32
                && w != 64 && w != 128)
        {
            _gf_errno = GF_E_COMP__W;
            return 0;
        }
        if (w < 128 && (poly >> (w/2)) != 0)
        {
            _gf_errno = GF_E_COMP_PP;
            return 0;
        }
        if (divide_type != GF_DIVIDE_DEFAULT)
        {
            _gf_errno = GF_E_DIVCOMP;
            return 0;
        }
        if (arg1 != 2)
        {
