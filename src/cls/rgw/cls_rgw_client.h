...
protected:
    ...
    virtual bool need_multiple_rounds()
    {
        return false;
    }
...
protected:
    ...
    bool need_multiple_rounds()
    {
        return true;
    }
    void add_object(int shard, const string& oid)
    {
        objs_container[shard] = oid;
    }
