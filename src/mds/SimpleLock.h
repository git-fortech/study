...
public:
    ...
    int get_cap_mask() const
    {
        ...
        {
        case CEPH_LOCK_IFILE:
            return (1 << CEPH_CAP_FILE_BITS) - 1;
        default:
            return (1 << CEPH_CAP_SIMPLE_BITS) - 1;
        }
    }
