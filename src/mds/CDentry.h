...
public:
    ...
    const char *pin_name(int p) const
    {
        ...
        case PIN_INODEPIN:
            return "inodepin";
        case PIN_FRAGMENTING:
            return "fragmenting";
        case PIN_PURGING:
            return "purging";
        case PIN_SCRUBPARENT:
            return "scrubparent";
        default:
...
public:
    struct linkage_t
    {
        ...
        inodeno_t get_remote_ino() const
        {
            return remote_ino;
        }
        unsigned char get_remote_d_type() const
        {
            return remote_d_type;
        }
...
public:
    ...
    __u32 get_hash() const
    {
        return hash;
    }

    // linkage
    const linkage_t *get_linkage() const
    {
        return &linkage;
    }
    ...
    void set_projected_version(version_t v)
    {
        projected_version = v;
    }
