...
public:
    ...
    bool get_inline_data_enabled()
    {
        return inline_data_enabled;
    }
    void set_inline_data_enabled(bool enabled)
    {
    ...
    uint64_t get_max_filesize()
    {
        return max_file_size;
    }
    void set_max_filesize(uint64_t m)
    {
        max_file_size = m;
    }
    ...
    const std::string &get_fs_name() const
    {
        return fs_name;
    }
    ...
    void clear_snaps_allowed()
    {
        clear_flag(CEPH_MDSMAP_ALLOW_SNAPS);
    }
    bool allows_snaps() const
    {
        return test_flag(CEPH_MDSMAP_ALLOW_SNAPS);
    }
    ...
    void clear_multimds_allowed()
    {
        clear_flag(CEPH_MDSMAP_ALLOW_MULTIMDS);
    }
    bool allows_multimds() const
    {
        return test_flag(CEPH_MDSMAP_ALLOW_MULTIMDS);
    }
    ...
    void clear_dirfrags_allowed()
    {
        clear_flag(CEPH_MDSMAP_ALLOW_DIRFRAGS);
    }
    bool allows_dirfrags() const
    {
        return test_flag(CEPH_MDSMAP_ALLOW_DIRFRAGS);
    }
    ...
    void set_modified(utime_t mt)
    {
        modified = mt;
    }

    epoch_t get_last_failure() const
    {
        return last_failure;
    }
    epoch_t get_last_failure_osd_epoch() const
    {
        return last_failure_osd_epoch;
    }

    mds_rank_t get_max_mds() const
    {
        return max_mds;
    }
    void set_max_mds(mds_rank_t m)
    {
        max_mds = m;
    }

    mds_rank_t get_tableserver() const
    {
        return tableserver;
    }
    mds_rank_t get_root() const
    {
        return root;
    }

    const std::set<int64_t> &get_data_pools() const
    {
        return data_pools;
    }
    int64_t get_first_data_pool() const
    {
        return *data_pools.begin();
    }
    ...
    const std::map<mds_gid_t,mds_info_t>& get_mds_info() const
    {
        return mds_info;
    }
    ...
    // mds states
    bool is_down(mds_rank_t m) const
    {
        return up.count(m) == 0;
    }
    bool is_up(mds_rank_t m) const
    {
        return up.count(m);
    }
    bool is_in(mds_rank_t m) const
    {
        return up.count(m) || failed.count(m);
    }
    bool is_out(mds_rank_t m) const
    {
        return !is_in(m);
    }

    bool is_failed(mds_rank_t m) const
    {
        return failed.count(m);
    }
    bool is_stopped(mds_rank_t m) const
    {
        return stopped.count(m);
    }

    bool is_dne(mds_rank_t m) const
    {
        return in.count(m) == 0;
    }
    ...
    bool is_boot(mds_rank_t m) const
    {
        return get_state(m) == STATE_BOOT;
    }
    bool is_creating(mds_rank_t m) const
    {
        return get_state(m) == STATE_CREATING;
    }
    bool is_starting(mds_rank_t m) const
    {
        return get_state(m) == STATE_STARTING;
    }
    bool is_replay(mds_rank_t m) const
    {
        return get_state(m) == STATE_REPLAY;
    }
    bool is_resolve(mds_rank_t m) const
    {
        return get_state(m) == STATE_RESOLVE;
    }
    bool is_reconnect(mds_rank_t m) const
    {
        return get_state(m) == STATE_RECONNECT;
    }
    bool is_rejoin(mds_rank_t m) const
    {
        return get_state(m) == STATE_REJOIN;
    }
    bool is_clientreplay(mds_rank_t m) const
    {
        return get_state(m) == STATE_CLIENTREPLAY;
    }
    bool is_active(mds_rank_t m) const
    {
        return get_state(m) == STATE_ACTIVE;
    }
    bool is_stopping(mds_rank_t m) const
    {
        return get_state(m) == STATE_STOPPING;
    }
